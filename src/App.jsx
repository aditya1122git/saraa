...
function SketchCards() {
  ...
  return (
    <div className="sketch-cards-section">
      <h3 className="sketch-cards-title fancy-font">Some of your beautiful sketches 🎨</h3>
        ...
        {sketches.map((sketch, i) => (
          <div className="sketch-card" key={i}>
            ...
            <div className="sketch-placeholder" style={{ display: 'none' }}>
              ...
              <div className="sketch-missing-text">Add {sketch.src.replace('/', '')} to public folder</div>
            </div>
